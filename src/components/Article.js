  ...
  return (
    <article className='w-full md:flex md:flex-col md:items-center'>
        ...
        <section className='w-full h-full flex flex-col md:w-3/5 lg:flex-row lg:w-full'>
            ...
            <BuilderBlockElectric photo={Gline} model="GLine" price="2849" sentence1="All terain met" sentence2='grote 20" banden'/>
            <BuilderBlockElectric photo={Cline} model="CLine" price="1599" sentence1="Meest modulair met" sentence2="optie tot electrisch"/>
            <BuilderBlockElectric photo={Pline} model="PLine" price="2890" sentence1="Licht gewicht met" sentence2="titanium accenten"/>

...
function Section() {
  return (
    <article className='w-full h-[1000px] flex flex-col justify-center items-center md:flex-row md:h-[350px] lg:h-[480px]'>
        ...
        <Block button="Brompton Builder" link='https://vouwfiets.nl/' tekst="Geen Brompton is hetzelfde en aan u om deze samen te stellen. dankzij onze online Brompton builder stelt u gemakkelijk en eenvoudig uw persoonlijke brompton samen"/>
    </article>
  );
}
